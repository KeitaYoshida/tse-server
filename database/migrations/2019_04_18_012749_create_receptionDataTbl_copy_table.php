...
class CreateReceptionDataTblCopyTable extends Migration {
	...
	public function up()
	{
		Schema::create('receptionDataTbl_copy', function(Blueprint $table)
		{
			...
			$table->string('orderConstCode', 30)->nullable()->comment('手配工事番号');
			$table->string('makeConstCode', 30)->nullable()->index('makeConstCode');
			...
			$table->integer('orderNum')->nullable()->comment('数量');
	...
	{
		Schema::drop('receptionDataTbl_copy');
	}
